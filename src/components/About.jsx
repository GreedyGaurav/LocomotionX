  ...
  return (
    <div className="px-4 py-6 max-w-screen-xl mx-auto">
      <section className="flex flex-col md:flex-row justify-between items-center text-justify space-y-8 md:space-y-0 md:gap-8">
        ...
        <div className="md:w-1/2 md:pl-8">
          ...
          <p className="text-lg text-gray-600">
            Welcome to LocomotionX, the ultimate solution for train travel
          ...
          <p className="text-lg text-gray-600 mt-4">
            At LocomotionX, we are passionate about train travel and we want to
          ...
          <p className="text-lg text-gray-600 mt-4">
            Thank you for choosing LocomotionX for all your train travel needs.
      ...
      <section className="mt-12 text-justify">
        ...
        <p className="text-lg text-gray-600">
          Our website, LocomotionX, established in 2025, is a section of your
        ...
        <p className="text-lg text-gray-600 mt-4">
          LocomotionX offers a unique service that combines train travel and
        ...
        <p className="text-lg text-gray-600 mt-4">
          By using LocomotionX, travelers can search for trains between stations
        ...
        <p className="text-lg text-gray-600 mt-4">
          Overall, LocomotionX is an innovative and practical addition to your
